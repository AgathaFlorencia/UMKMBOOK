...
// ============================================================
// Redesign biar konsisten sama halaman Produk: panel gradient,
// search bar, tombol "+ Tambah Piutang" yang buka popup (bukan
// form nempel di halaman kayak versi lama), dan popup edit buat
// update pembayaran / status lunas.
//
// CATATAN PENTING soal lib/kasbon.ts:
// Desain target punya kolom "Tanggal", "Dibayarkan", dan "Kurang"
// yang belum ada di tipe Kasbon versi lama (yang cuma py
// nama_pelanggan + jumlah_utang + status). Supaya halaman ini
// jalan, tipe & fungsi di lib/kasbon.ts perlu ditambah field:
//
//   type Kasbon = {
//     id: string;
//     nama_pelanggan: string;
//     jumlah_utang: number;
//     dibayarkan: number;     // <-- BARU
//     tanggal: string;        // <-- BARU (ISO date string)
//     status: "lunas" | "belum_lunas";
//   };
//
// Dan tambah 1 fungsi baru buat update pembayaran/status:
//
//   async function updateKasbon(
//     id: string,
//     data: { dibayarkan: number; status: "lunas" | "belum_lunas" }
//   ): Promise<{ success: boolean; data?: Kasbon; error?: string }>
//
// `tambahKasbon` juga sebaiknya balikin `{ success, data, error }`
// (bukan cuma success/error) supaya row baru bisa langsung
// ditambahin ke tabel tanpa reload ulang semua data.
//
// Kalau nama fungsi/field di project kamu beda, tinggal sesuaikan
// bagian import & pemanggilannya di bawah — struktur UI-nya tetap
// sama.
